...
class ListasEntendimiento:
	def __init__(self):
		...
		self.listaNegaciones = ["No","no","Nó","nó","incorrecto","negativo","Negativo", "incierto", "falso", "nadie"]
		self.listaBartender = ["Listo","listo","terminado","Terminado","termine", "Termine", "listos", "Listos", "ya", "Ya"]
