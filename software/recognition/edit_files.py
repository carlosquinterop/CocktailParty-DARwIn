...
class PersonFiles:
    ...
    def __init__(self, name, personId, hairColor=" ", glasses=" ", gender=" ", age=0, smile=0, pose="", emotion="", beard="", eyesOpen = 0, mouthOpen = 0, bald = 0, sideburns = 0,\
        eyeMakeUp = False, lipMakeUp = False, headWear = 0, mask = 0, mustache = 0):
        self.name = name
